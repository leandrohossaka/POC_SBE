...
namespace SbeFIX
{
    public sealed partial class NewOrderSingle_with_Custodian
    {
        public const ushort BlockLength = (ushort)76;
        ...
        private readonly NewOrderSingle_with_Custodian _parentMessage;
        ...
        public NewOrderSingle_with_Custodian()
        {
            _parentMessage = this;
        }
        ...
        public const int CustodianId = 35507;
        public const int CustodianSinceVersion = 0;
        public const int CustodianDeprecated = 0;
        public bool CustodianInActingVersion()
        {
            return _actingVersion >= CustodianSinceVersion;
        }

        public static string CustodianMetaAttribute(MetaAttribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute.Epoch: return "";
        ...
        public const uint CustodianNullValue = 4294967295U;
        public const uint CustodianMinValue = 0U;
        public const uint CustodianMaxValue = 4294967294U;

        public uint Custodian
        {
            get
            {
        ...
        public const int CustodyAccountId = 35508;
        public const int CustodyAccountSinceVersion = 0;
        public const int CustodyAccountDeprecated = 0;
        public bool CustodyAccountInActingVersion()
        {
            return _actingVersion >= CustodyAccountSinceVersion;
        }

        public static string CustodyAccountMetaAttribute(MetaAttribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute.Epoch: return "";
        ...
        public const uint CustodyAccountNullValue = 4294967295U;
        public const uint CustodyAccountMinValue = 0U;
        public const uint CustodyAccountMaxValue = 4294967294U;

        public uint CustodyAccount
        {
            get
            {
                return _buffer.Uint32GetLittleEndian(_offset + 45);
            }
            set
            {
                _buffer.Uint32PutLittleEndian(_offset + 45, value);
            }
        }


        public const int CustodyAllocationTypeId = 35509;
        public const int CustodyAllocationTypeSinceVersion = 0;
        public const int CustodyAllocationTypeDeprecated = 0;
        public bool CustodyAllocationTypeInActingVersion()
        {
            return _actingVersion >= CustodyAllocationTypeSinceVersion;
        }

        public static string CustodyAllocationTypeMetaAttribute(MetaAttribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute.Epoch: return "";
        ...
        public const uint CustodyAllocationTypeNullValue = 4294967295U;
        public const uint CustodyAllocationTypeMinValue = 0U;
        public const uint CustodyAllocationTypeMaxValue = 4294967294U;

        public uint CustodyAllocationType
        {
            get
            {
                return _buffer.Uint32GetLittleEndian(_offset + 49);
            }
            set
            {
                _buffer.Uint32PutLittleEndian(_offset + 49, value);
            }
        }
        ...
        public uint InvestorID
        {
            get
            {
                return _buffer.Uint32GetLittleEndian(_offset + 53);
            }
            set
            {
                _buffer.Uint32PutLittleEndian(_offset + 53, value);
            }
        }
        ...
        public uint OrderQty
        {
            get
            {
                return _buffer.Uint32GetLittleEndian(_offset + 57);
            }
            set
            {
                _buffer.Uint32PutLittleEndian(_offset + 57, value);
            }
        }
        ...
        public uint MinQty
        {
            get
            {
                return _buffer.Uint32GetLittleEndian(_offset + 61);
            }
            set
            {
                _buffer.Uint32PutLittleEndian(_offset + 61, value);
            }
        }
        ...
        public uint MaxFloor
        {
            get
            {
                return _buffer.Uint32GetLittleEndian(_offset + 65);
            }
            set
            {
                _buffer.Uint32PutLittleEndian(_offset + 65, value);
            }
        }
        ...
        public byte MarketSegmentID
        {
            get
            {
                return _buffer.Uint8Get(_offset + 69);
            }
            set
            {
                _buffer.Uint8Put(_offset + 69, value);
            }
        }
        ...
        public Side Side
        {
            get
            {
                return (Side)_buffer.CharGet(_offset + 70);
            }
            set
            {
                _buffer.CharPut(_offset + 70, (byte)value);
            }
        }
        ...
        public OrdType OrdType
        {
            get
            {
                return (OrdType)_buffer.CharGet(_offset + 71);
            }
            set
            {
                _buffer.CharPut(_offset + 71, (byte)value);
            }
        }
        ...
        public TimeInForce TimeInForce
        {
            get
            {
                return (TimeInForce)_buffer.CharGet(_offset + 72);
            }
            set
            {
        ...
        public Bool MmProtectionReset
        {
            get
            {
                return (Bool)_buffer.Uint8Get(_offset + 73);
            }
            set
            {
                _buffer.Uint8Put(_offset + 73, (byte)value);
            }
        }
        ...
        public RoutingInstruction RoutingInstruction
        {
            get
            {
                return (RoutingInstruction)_buffer.Uint8Get(_offset + 74);
            }
            set
            {
        ...
        public byte OrdTagID
        {
            get
            {
                return _buffer.Uint8Get(_offset + 75);
            }
            set
            {
                _buffer.Uint8Put(_offset + 75, value);
            }
        }
