...
namespace SbeFIX
{
    public sealed partial class SimpleReplaceOrder
    {
        ...
        private readonly SimpleReplaceOrder _parentMessage;
        ...
        public MessageType MessageType
        {
            get
            {
                return MessageType.SimpleReplaceOrder;
            }
        }
        ...
        public Side Side
        {
            get
            {
                return (Side)_buffer.CharGet(_offset + 37);
            }
            set
            {
                _buffer.CharPut(_offset + 37, (byte)value);
            }
        }
        ...
        public byte GetEnteringTrader(int index)
        {
            ...
            return _buffer.CharGet(_offset + 38 + (index * 1));
        }
        ...
        public void SetEnteringTrader(int index, byte value)
        {
            ...
            _buffer.CharPut(_offset + 38 + (index * 1), value);
        }
        ...
        public int GetEnteringTrader(Span<byte> dst)
        {
            ...
            _buffer.GetBytes(_offset + 38, dst);
            return length;
        }
        ...
        public void SetEnteringTrader(ReadOnlySpan<byte> src)
        {
            ...
            _buffer.SetBytes(_offset + 38, src);
        }
        ...
        public byte GetExecutingTrader(int index)
        {
            ...
            return _buffer.CharGet(_offset + 43 + (index * 1));
        }
        ...
        public void SetExecutingTrader(int index, byte value)
        {
            ...
            _buffer.CharPut(_offset + 43 + (index * 1), value);
        }
        ...
        public int GetExecutingTrader(Span<byte> dst)
        {
            ...
            _buffer.GetBytes(_offset + 43, dst);
            return length;
        }
        ...
        public void SetExecutingTrader(ReadOnlySpan<byte> src)
        {
            ...
            _buffer.SetBytes(_offset + 43, src);
        }
    }
}
