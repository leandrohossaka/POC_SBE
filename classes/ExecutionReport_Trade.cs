...
namespace Sbe
{
    public sealed partial class ExecutionReport_Trade
    {
        public const ushort BlockLength = (ushort)112;
        ...
        private readonly ExecutionReport_Trade _parentMessage;
        ...
        public Price LastPx
        {
            get
            {
                _lastPx.Wrap(_buffer, _offset + 66, _actingVersion);
                return _lastPx;
            }
        }
        ...
        public ushort TradeDate
        {
            get
            {
                return _buffer.Uint16GetLittleEndian(_offset + 86);
            }
            set
            {
                _buffer.Uint16PutLittleEndian(_offset + 86, value);
            }
        }
        ...
        public ulong CrossID
        {
            get
            {
                return _buffer.Uint64GetLittleEndian(_offset + 93);
            }
            set
            {
                _buffer.Uint64PutLittleEndian(_offset + 93, value);
            }
        }
        ...
        public ulong ExecRefID
        {
            get
            {
                return _buffer.Uint64GetLittleEndian(_offset + 101);
            }
            set
            {
                _buffer.Uint64PutLittleEndian(_offset + 101, value);
            }
        }


        public const int MultiLegReportingTypeId = 442;
        public const int MultiLegReportingTypeSinceVersion = 0;
        public const int MultiLegReportingTypeDeprecated = 0;
        public bool MultiLegReportingTypeInActingVersion()
        {
            return _actingVersion >= MultiLegReportingTypeSinceVersion;
        }
        ...
        public MultiLegReportingType MultiLegReportingType
        {
            get
            {
                return (MultiLegReportingType)_buffer.CharGet(_offset + 109);
            }
            set
            {
                _buffer.CharPut(_offset + 109, (byte)value);
            }
        }


        public const int TotNoRelatedSymId = 393;
        public const int TotNoRelatedSymSinceVersion = 0;
        public const int TotNoRelatedSymDeprecated = 0;
        public bool TotNoRelatedSymInActingVersion()
        {
            return _actingVersion >= TotNoRelatedSymSinceVersion;
        }
        ...
        public const byte TotNoRelatedSymNullValue = (byte)255;
        public const byte TotNoRelatedSymMinValue = (byte)0;
        public const byte TotNoRelatedSymMaxValue = (byte)254;

        public byte TotNoRelatedSym
        {
            get
            {
                return _buffer.Uint8Get(_offset + 110);
            }
            set
            {
                _buffer.Uint8Put(_offset + 110, value);
            }
        }


        public const int OrderCategoryId = 1115;
        public const int OrderCategorySinceVersion = 0;
        public const int OrderCategoryDeprecated = 0;
        public bool OrderCategoryInActingVersion()
        {
            return _actingVersion >= OrderCategorySinceVersion;
        }
        ...
        public OrderCategory OrderCategory
        {
            get
            {
                return (OrderCategory)_buffer.CharGet(_offset + 111);
            }
            set
            {
