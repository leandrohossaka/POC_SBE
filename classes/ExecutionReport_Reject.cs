...
namespace Sbe
{
    public sealed partial class ExecutionReport_Reject
    {
        ...
        private readonly ExecutionReport_Reject _parentMessage;
        ...
        public MessageType MessageType
        {
            get
            {
                return MessageType.ExecutionReport_Reject;
            }
        }
        ...
        public const int OrdRejReasonId = 103;
        public const int OrdRejReasonSinceVersion = 0;
        public const int OrdRejReasonDeprecated = 0;
        public bool OrdRejReasonInActingVersion()
        {
            return _actingVersion >= OrdRejReasonSinceVersion;
        }

        public static string OrdRejReasonMetaAttribute(MetaAttribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute.Epoch: return "";
        ...
        public const uint OrdRejReasonNullValue = 4294967295U;
        public const uint OrdRejReasonMinValue = 0U;
        public const uint OrdRejReasonMaxValue = 4294967294U;

        public uint OrdRejReason
        {
            get
            {
