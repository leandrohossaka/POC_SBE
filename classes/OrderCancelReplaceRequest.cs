...
namespace Sbe
{
    ...
    {
        public const ushort BlockLength = (ushort)92;
        ...
        public Price Price
        {
            get
            {
                _price.Wrap(_buffer, _offset + 24, _actingVersion);
                return _price;
            }
        }
        ...
        public Price StopPx
        {
            get
            {
                _stopPx.Wrap(_buffer, _offset + 32, _actingVersion);
                return _stopPx;
            }
        }
        ...
        public int GetEnteringTrader(Span<byte> dst)
        {
            ...
            _buffer.GetBytes(_offset + 44, dst);
            return length;
        }
        ...
        public void SetEnteringTrader(ReadOnlySpan<byte> src)
        {
            ...
            _buffer.SetBytes(_offset + 44, src);
        }
        ...
        public int GetExecutingTrader(Span<byte> dst)
        {
            ...
            _buffer.GetBytes(_offset + 49, dst);
            return length;
        }
        ...
        public void SetExecutingTrader(ReadOnlySpan<byte> src)
        {
            ...
            _buffer.SetBytes(_offset + 49, src);
        }
        ...
        public ushort ExpireDate
        {
            get
            {
                return _buffer.Uint16GetLittleEndian(_offset + 54);
            }
            set
            {
                _buffer.Uint16PutLittleEndian(_offset + 54, value);
            }
        }
        ...
        public byte MarketSegmentID
        {
            get
            {
                return _buffer.Uint8Get(_offset + 84);
            }
            set
            {
                _buffer.Uint8Put(_offset + 84, value);
            }
        }
        ...
        public Side Side
        {
            get
            {
                return (Side)_buffer.CharGet(_offset + 85);
            }
            set
            {
                _buffer.CharPut(_offset + 85, (byte)value);
            }
        }
        ...
        public OrdType OrdType
        {
            get
            {
                return (OrdType)_buffer.CharGet(_offset + 86);
            }
            set
            {
                _buffer.CharPut(_offset + 86, (byte)value);
            }
        }
        ...
        public TimeInForce TimeInForce
        {
            get
            {
                return (TimeInForce)_buffer.CharGet(_offset + 87);
            }
            set
            {
                _buffer.CharPut(_offset + 87, (byte)value);
            }
        }
        ...
        public Bool MmProtectionReset
        {
            get
            {
                return (Bool)_buffer.Uint8Get(_offset + 88);
            }
            set
            {
        ...
        public RoutingInstruction RoutingInstruction
        {
            get
            {
                return (RoutingInstruction)_buffer.Uint8Get(_offset + 89);
            }
            set
            {
        ...
        public const int AccountTypeId = 581;
        ...
        public AccountType AccountType
        {
            get
            {
                return (AccountType)_buffer.Uint8Get(_offset + 90);
            }
            set
            {
        ...
        public byte OrdTagID
        {
            get
            {
                return _buffer.Uint8Get(_offset + 91);
            }
            set
            {
                _buffer.Uint8Put(_offset + 91, value);
            }
        }
