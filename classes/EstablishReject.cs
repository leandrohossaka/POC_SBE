...
namespace Sbe
{
    public sealed partial class EstablishReject
    {
        ...
        private readonly EstablishReject _parentMessage;
        ...
        public EstablishRejectCode Code
        {
            get
            {
                return (EstablishRejectCode)_buffer.Uint8Get(_offset + 26);
            }
            set
            {
