...
namespace Sbe
{
    public sealed partial class ExecutionReport_New
    {
        ...
        private readonly ExecutionReport_New _parentMessage;
        ...
        public MessageType MessageType
        {
            get
            {
                return MessageType.ExecutionReport_New;
            }
        }
        ...
        public ExecType ExecType
        {
            get
            {
                return (ExecType)_buffer.CharGet(_offset + 40);
            }
            set
            {
        ...
        public OrdStatus OrdStatus
        {
            get
            {
                return (OrdStatus)_buffer.CharGet(_offset + 41);
            }
            set
            {
                _buffer.CharPut(_offset + 41, (byte)value);
            }
        }
        ...
        public const int WorkingIndicatorId = 636;
        public const int WorkingIndicatorSinceVersion = 0;
        public const int WorkingIndicatorDeprecated = 0;
        public bool WorkingIndicatorInActingVersion()
        {
            return _actingVersion >= WorkingIndicatorSinceVersion;
        }

        public static string WorkingIndicatorMetaAttribute(MetaAttribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute.Epoch: return "";
        ...
        public Bool WorkingIndicator
        {
            get
            {
                return (Bool)_buffer.Uint8Get(_offset + 55);
            }
            set
            {
        ...
        public ExecRestatementReason ExecRestatementReason
        {
            get
            {
                return (ExecRestatementReason)_buffer.Uint8Get(_offset + 56);
            }
            set
            {
        ...
        public const int ProtectionPriceId = 35001;
        public const int ProtectionPriceSinceVersion = 0;
        public const int ProtectionPriceDeprecated = 0;
        public bool ProtectionPriceInActingVersion()
        {
            return _actingVersion >= ProtectionPriceSinceVersion;
        }
        ...
        private readonly Price _protectionPrice = new Price();

        public Price ProtectionPrice
        {
            get
            {
                _protectionPrice.Wrap(_buffer, _offset + 57, _actingVersion);
                return _protectionPrice;
            }
        }
        ...
        public MultiLegReportingType MultiLegReportingType
        {
            get
            {
                return (MultiLegReportingType)_buffer.CharGet(_offset + 67);
            }
            set
            {
                _buffer.CharPut(_offset + 67, (byte)value);
            }
        }
