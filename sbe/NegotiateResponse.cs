...
namespace Sbe
{
    public sealed partial class NegotiateResponse
    {
        ...
        private readonly NegotiateResponse _parentMessage;
        ...
        public const int ServerFlowId = 35524;
        public const int ServerFlowSinceVersion = 0;
        public const int ServerFlowDeprecated = 0;
        public bool ServerFlowInActingVersion()
        {
            return _actingVersion >= ServerFlowSinceVersion;
        }

        public static string ServerFlowMetaAttribute(MetaAttribute metaAttribute)
        {
            switch (metaAttribute)
            {
                case MetaAttribute.Epoch: return "";
