...
namespace Sbe
{
    public sealed partial class ExecutionReport_Modify
    {
        ...
        private readonly ExecutionReport_Modify _parentMessage;
        ...
        public MessageType MessageType
        {
            get
            {
                return MessageType.ExecutionReport_Modify;
            }
        }
        ...
        public byte GetExecutingTrader(int index)
        {
            ...
            return _buffer.CharGet(_offset + 54 + (index * 1));
        }
        ...
        public void SetExecutingTrader(int index, byte value)
        {
            ...
            _buffer.CharPut(_offset + 54 + (index * 1), value);
        }
        ...
        public int GetExecutingTrader(Span<byte> dst)
        {
            ...
            _buffer.GetBytes(_offset + 54, dst);
            return length;
        }
        ...
        public void SetExecutingTrader(ReadOnlySpan<byte> src)
        {
            ...
            _buffer.SetBytes(_offset + 54, src);
        }
        ...
        public Price ProtectionPrice
        {
            get
            {
                _protectionPrice.Wrap(_buffer, _offset + 59, _actingVersion);
        ...
        public ushort TradeDate
        {
            get
            {
                return _buffer.Uint16GetLittleEndian(_offset + 67);
            }
            set
            {
                _buffer.Uint16PutLittleEndian(_offset + 67, value);
            }
        }
        ...
        public MultiLegReportingType MultiLegReportingType
        {
            get
            {
                return (MultiLegReportingType)_buffer.CharGet(_offset + 69);
            }
            set
            {
                _buffer.CharPut(_offset + 69, (byte)value);
            }
        }
